		...
		public static IServiceCollection RegisterJwtServices(this IServiceCollection services, IConfiguration config)
		{
			...
			}).AddJwtBearer(opt =>
			{
				...
				opt.TokenValidationParameters = new TokenValidationParameters()
				{
					...
					ValidIssuer = "satgetsin.up.railway.app",
					ValidAudience = "satgetsin.up.railway.app",
					RequireExpirationTime = true,
					//IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(config["JWT:secret_key"]))
					IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."))
				};
			});
			return services;
		}
