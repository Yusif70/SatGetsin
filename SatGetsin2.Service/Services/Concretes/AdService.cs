...
namespace SatGetsin2.Service.Services.Concretes
{
    public class AdService : IAdService
    {
        ...
        public AdService(IMapper mapper, IAdRepository adRepository, IImageRepository imageRepository, IMediaService mediaService, UserManager<AppUser> userManager, IFavoriteRepository favoriteRepository)
        {
            _mapper = mapper;
